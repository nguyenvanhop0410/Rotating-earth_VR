...
- **WebXR / VR Mode**: Enter VR directly from browser (when device/browser supports WebXR).
- **Auto-Rotating Earth**: Earth rotates continuously around its axis.
...
1. Open the app in a WebXR-compatible browser (for example, Meta Quest Browser or Chrome with supported headset).
2. Click **Enter VR** button.
3. Look around naturally to inspect Earth from multiple viewing angles.
